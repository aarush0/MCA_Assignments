...
def parse_args():
    ...
    parser.add_argument('--docs', nargs='?', default='C:/Users/Aarush/Desktop/MCA/MCA_HW3/src/Problem_2/data/MED.ALL',
                        help='Path of the document file.')
    parser.add_argument('--queries', nargs='?', default='C:/Users/Aarush/Desktop/MCA/MCA_HW3/src/Problem_2/data/MED.QRY',
                        help='Path of the query file.')
    parser.add_argument('--gt', nargs='?', default='C:/Users/Aarush/Desktop/MCA/MCA_HW3/src/Problem_2/data/MED.REL',
...
if __name__ == '__main__':
    ...
    #print(len(list(tfidf_model.get_feature_names())))
    ...
    rf_sim_matrix = relevance_feedback(vec_docs, vec_queries, sim_matrix, gt, 15)
    if args.verbose:
    ...
    rf_sim_matrix = relevance_feedback_exp(vec_docs, vec_queries, sim_matrix, tfidf_model, gt, n=10)
    if args.verbose:
        for i in range(rf_sim_matrix.shape[1]):
            ranked_documents = np.argsort(-rf_sim_matrix[:, i])
            print 'Query:', i+1, 'Top relevant 10 documents:', ranked_documents[:10] + 1
